...
const ViewUserProfile = ({ user, updateProfileClick }) => {
    ...
    return (
        <Card className='mt-2 border-0 rounded-0 shadow-sm'>
            <CardBody>
                <h3 className='text-uppercase'>Account Details</h3>

                <Container className='text-center'>
                    <img style={{ maxWidth: '200px', maxHeight: '200px' }} src={user.image ? user.image : 'https://iili.io/HO2J2cv.md.png'} alt="user profile picture" className='img-fluid  rounded-circle' />
                </Container>
